...
const governedFilters = Object.freeze([
  ...
  'label=com.srtaller.tl05=postgresql',
  'label=com.srtaller.tl06=postgresql',
  'label=com.srtaller.tl07=postgresql',
...
async function dryInventory() {
  ...
  const requiredScripts = [
    ...
    'scripts/test-tl05-postgresql.mjs',
    'scripts/test-tl06-postgresql.mjs',
    'scripts/test-tl07-postgresql.mjs',
...
if (process.argv.includes('--dry-run')) {
  ...
  const operations = {
    ...
    tl02Postgresql: async () => {
      ...
      if (!result.stdout.includes('TL-02 PostgreSQL PASS: 89 migrations, second run 0 pending')) throw new Error('TL-02 PostgreSQL evidence is incomplete');
    ...
    tl03Postgresql: async () => {
      ...
      if (!result.stdout.includes('TL-03 PostgreSQL PASS: 89 migrations, second run 0 pending')) throw new Error('TL-03 PostgreSQL evidence is incomplete');
    ...
    tl04Postgresql: async () => {
      ...
      if (!result.stdout.includes('TL-04 PostgreSQL PASS: 89 migrations, second run 0 pending')) throw new Error('TL-04 PostgreSQL evidence is incomplete');
    ...
    tl05Postgresql: async () => {
      ...
      if (!result.stdout.includes('TL-05 PostgreSQL PASS: 89 migrations, second run 0 pending')) throw new Error('TL-05 PostgreSQL evidence is incomplete');
    ...
    tl06Postgresql: async () => {
      ...
      if (!result.stdout.includes('TL-06 PostgreSQL PASS: 89 migrations, second run 0 pending')) throw new Error('TL-06 PostgreSQL evidence is incomplete');
      return Object.freeze({ tests: skipInventory.material.tl06Postgresql, skips: 0, cleanup: 'PASS' });
    },
    tl07Postgresql: async () => {
      const result = await runStreamingCommand(process.execPath, ['scripts/test-tl07-postgresql.mjs'], { timeoutMs: 5 * 60_000 });
      if (!result.stdout.includes('TL-07 PostgreSQL PASS: 89 migrations, second run 0 pending')) throw new Error('TL-07 PostgreSQL evidence is incomplete');
      return Object.freeze({ tests: skipInventory.material.tl07Postgresql, skips: 0, cleanup: 'PASS' });
    },
