...
try {
  ...
  const summary = assertPostgresqlTestSummary(testResult.stdout); assert.equal(summary.pass, 2); output = `${testResult.stdout}TL-02 PostgreSQL PASS: 89 migrations, second run 0 pending\n`;
