...
try {
  ...
  const summary = assertPostgresqlTestSummary(testResult.stdout); assert.equal(summary.pass, 1); output = `${testResult.stdout}TL-02 PostgreSQL PASS: 76 migrations, second run 0 pending\n`;
