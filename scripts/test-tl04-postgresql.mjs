...
try {
  ...
  const summary = assertPostgresqlTestSummary(testResult.stdout); assert.equal(summary.pass, 3); output = `${testResult.stdout}TL-04 PostgreSQL PASS: 87 migrations, second run 0 pending\n`;
