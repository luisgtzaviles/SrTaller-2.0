...
try {
  ...
  const migrationResult = JSON.parse(migration.stdout.trim()); if (migrationResult.pending !== 0 || migrationResult.applied !== 86) throw new Error('PBI-041 migration set is incomplete');
