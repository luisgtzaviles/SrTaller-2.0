...
try {
  ...
  const result = await execute(process.execPath, ['--no-maglev', '--test', '--test-concurrency=1', 'test/bulk-catalog-postgresql.test.mjs', 'test/catalog-authorization-postgresql.test.mjs'], { encoding: 'utf8', env: { ...process.env, SR_PBI041_PG_TEST: '1', SR_PBI041_AUTH_PG_TEST: '1', SR_PBI041_PG_HOST: '127.0.0.1', SR_PBI041_PG_PORT: port, SR_PBI041_PG_NAME: database, SR_PBI041_PG_USER: user, SR_PBI041_PG_PASSWORD: password }, maxBuffer: 20 * 1024 * 1024, timeout: 90_000 });
