...
export function DashboardPage(): React.JSX.Element {
  return (
    <div className={styles.pageStack}>
      ...
      <section className={styles.metrics} aria-label="Resumen operativo local">
        ...
        <article><ShieldCheck aria-hidden="true" size={24} /><small>Contexto</small><strong>Activo</strong><span>Estación y sesión verificadas</span></article>
      </section>
      <EmptyState
