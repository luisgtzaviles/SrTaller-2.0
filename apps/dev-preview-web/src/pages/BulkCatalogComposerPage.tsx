  ...
  return <div className={styles.page}>
    ...
    <div className={`${styles.layout} ${!sourcesOpen ? styles.layoutCollapsed : ''}`}>
      ...
      <main className={styles.composer}>
        ...
        </> : <section className={styles.newLoadStart}><EmptyState title="Inicia una nueva carga" description="Elige explícitamente el proveedor antes de pegar una lista. Explorar fuentes y versiones no inicia una carga." /><Button id="supplier-gate-main-new-load" tone="primary" onClick={() => openSupplierGate('supplier-gate-main-new-load')}><Plus size={17} />Nueva carga</Button></section>}
      </main>
    </div>
