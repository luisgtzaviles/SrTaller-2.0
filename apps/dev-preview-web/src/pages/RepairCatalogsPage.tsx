...
export function RepairCatalogsPage({ capabilities, csrfToken }: Readonly<{
  ...
  return (
    <div className={styles.page}>
      ...
      <CatalogModuleNavigation active="catalogs" />
      <div className={styles.headingRow}>
        <PageHeader eyebrow="Catálogos por módulo" title="Reparaciones" description="Administra los valores operativos propios del dominio de Reparaciones." />
        <div className={styles.modulePicker}>
          ...
          <select id="catalog-module" value="repairs" disabled><option value="repairs">Reparaciones</option></select>
        </div>
      </div>

      <nav className={styles.catalogTabs} aria-label="Catálogos de Reparaciones">
