...
export type SupplierCoverageItem = Readonly<{ itemId: string | null; canonicalTitle: string | null; observedTitle: string | null; baselineObservedTitle: string | null; status: 'ACTIVE' | 'INACTIVE' | null }>;
