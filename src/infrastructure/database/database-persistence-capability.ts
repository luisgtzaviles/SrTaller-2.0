...
type DatabaseTechnicalSchema = Pick<DatabaseSchema, 'branches' | 'tenants' | 'stations' | 'station_bindings' | 'station_credentials'> &
  Readonly<{
    ...
    catalog_internal_code_sequences: DatabaseSchema['catalog_internal_code_sequences'];
