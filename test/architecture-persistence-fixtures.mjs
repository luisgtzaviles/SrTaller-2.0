const databaseTypes = [
  ...
  'export interface BranchCommandTable { readonly tenant_id: string; readonly client_request_id: string; }',
  'export interface BranchAuditEventTable { readonly tenant_id: string; readonly event_id: string; }',
  'export interface TenantLifecycleEventTable { readonly tenant_id: string; readonly event_id: string; }',
  ...
  'export interface StationEnrollmentChallengeTable { readonly tenant_id: string; readonly challenge_id: string; }',
  'export interface StationEnrollmentConsumptionTable { readonly tenant_id: string; readonly challenge_id: string; }',
  'export interface StationAdministrationCommandTable { readonly tenant_id: string; readonly client_request_id: string; }',
  'export interface StationAuditEventTable { readonly tenant_id: string; readonly event_id: string; }',
