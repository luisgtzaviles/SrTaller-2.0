...
test('productive migration manifest is deterministic and owner-scoped', async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        fileName: '20260921120000_tenancy_create_bootstrap_foundation.js',
        migrationName: '20260921120000_tenancy_create_bootstrap_foundation',
        order: 76,
        owner: 'tenancy',
      },
      {
        fileName: '20260921121000_access_create_starter_tenant_admin_policy.js',
        migrationName: '20260921121000_access_create_starter_tenant_admin_policy',
        order: 77,
        owner: 'access',
      },
      {
        fileName: '20260921122000_tenancy_create_bootstrap_guards.js',
        migrationName: '20260921122000_tenancy_create_bootstrap_guards',
        order: 78,
        owner: 'tenancy',
      },
      {
        fileName: '20260921150000_registration_create_public_verification.js',
        migrationName: '20260921150000_registration_create_public_verification',
        order: 79,
        owner: 'registration',
      },
      {
        fileName: '20260921151000_registration_enable_retention_cleanup.js',
      ...
      {
        fileName: '20260921200000_access_create_admin_invitations.js',
        migrationName: '20260921200000_access_create_admin_invitations',
        order: 84,
        owner: 'access',
      },
      {
        fileName: '20260921201000_access_enable_admin_role_lifecycle.js',
        migrationName: '20260921201000_access_enable_admin_role_lifecycle',
        order: 85,
        owner: 'access',
      },
      {
        fileName: '20260921202000_access_enforce_global_pending_invitation_email.js',
        migrationName: '20260921202000_access_enforce_global_pending_invitation_email',
        order: 86,
        owner: 'access',
      },
      {
        fileName: '20260922090000_access_bound_admin_invitation_challenge_expiry.js',
