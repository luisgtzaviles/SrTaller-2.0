...
const directedAccessModule = [
  ...
  "import { AUTHENTICATION_USER_ADMISSION_VALIDATOR, AUTHENTICATION_USER_READER, USER_PRODUCT_RUNTIME } from '../users/index.js';",
  "import type { AuthenticationUserAdmissionValidator, AuthenticationUserReader, UserProductRuntime } from '../users/index.js';",
  '@Module({',
  '  imports: [RuntimeInfrastructureModule, StationsModule, UsersModule],',
  '  providers: [{',
  "    provide: 'DIRECTED_COMPOSITION_PROBE',",
  '    inject: [TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER, AUTHENTICATION_USER_ADMISSION_VALIDATOR, AUTHENTICATION_USER_READER, USER_PRODUCT_RUNTIME],',
  '    useFactory: (stationAdmission: TrustedStationAdmissionValidator, stations: TrustedStationContextResolver, userAdmission: AuthenticationUserAdmissionValidator, users: AuthenticationUserReader, userProduct: UserProductRuntime) => ({ stationAdmission, stations, userAdmission, users, userProduct }),',
  '  }, {',
...
const directedStationsModule = [
  "import { Module } from '@nestjs/common';",
  "import { BRANCH_SETTINGS_RUNTIME } from './index.js';",
  "import type { BranchSettingsRuntime } from './index.js';",
  ...
  '  }],',
  '  exports: [BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER],',
  '})',
  'export class StationsModule {}',
  '',
].join('\n');
...
const directedUsersModule = [
  "import { Module } from '@nestjs/common';",
  "import { AUTHENTICATION_USER_ADMISSION_VALIDATOR, AUTHENTICATION_USER_READER, USER_PRODUCT_RUNTIME } from './index.js';",
  "import type { AuthenticationUserAdmissionValidator, AuthenticationUserReader, UserProductRuntime } from './index.js';",
  '@Module({',
  '  providers: [{',
  ...
  '  }],',
  '  exports: [AUTHENTICATION_USER_ADMISSION_VALIDATOR, AUTHENTICATION_USER_READER, USER_PRODUCT_RUNTIME],',
  '})',
...
export const fixtureCases = [
  ...
  },
  {
    ...
    files: {
      ...
      'src/modules/access/access.module.ts': directedAccessModule.replace(
        'inject: [TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER, AUTHENTICATION_USER_ADMISSION_VALIDATOR, AUTHENTICATION_USER_READER, USER_PRODUCT_RUNTIME]',
        'inject: [TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER, TRUSTED_STATION_CONTEXT_RESOLVER, AUTHENTICATION_USER_ADMISSION_VALIDATOR, AUTHENTICATION_USER_READER, USER_PRODUCT_RUNTIME]',
      ),
    },
  },
  {
  ...
  },
  {
    ...
    files: {
      ...
      'src/modules/stations/stations.module.ts': directedStationsModule.replace(
        'exports: [BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER]',
        'exports: [BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER, TRUSTED_STATION_CONTEXT_RESOLVER]',
      ),
    },
  },
  {
