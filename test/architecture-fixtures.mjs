...
const directedAccessModule = [
  ...
  "import { BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME } from '../stations/index.js';",
  "import type { BranchAdministrationRuntime, BranchSettingsRuntime } from '../stations/index.js';",
...
const directedStationsModule = [
  ...
  "import { BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME } from './index.js';",
  "import type { BranchAdministrationRuntime, BranchSettingsRuntime } from './index.js';",
  ...
  '  }],',
  '  exports: [BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER],',
  '})',
  'export class StationsModule {}',
  '',
].join('\n');
...
export const fixtureCases = [
  ...
  },
  {
    ...
    files: {
      ...
      'src/modules/stations/stations.module.ts': directedStationsModule.replace(
        'exports: [BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER]',
        'exports: [BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER, TRUSTED_STATION_CONTEXT_RESOLVER]',
      ),
    },
  },
  {
