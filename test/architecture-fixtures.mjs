...
const directedStationsModule = [
  ...
  '  }],',
  '  exports: [ADMIN_INVITATION_BRANCH_COMMIT_VALIDATOR, BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER],',
  '})',
  'export class StationsModule {}',
  '',
].join('\n');
...
export const fixtureCases = [
  ...
  },
  {
    ...
    files: {
      ...
      'src/modules/stations/stations.module.ts': directedStationsModule.replace(
        'exports: [ADMIN_INVITATION_BRANCH_COMMIT_VALIDATOR, BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER]',
        'exports: [ADMIN_INVITATION_BRANCH_COMMIT_VALIDATOR, BRANCH_ADMINISTRATION_RUNTIME, BRANCH_SETTINGS_RUNTIME, TRUSTED_STATION_ADMISSION_VALIDATOR, TRUSTED_STATION_CONTEXT_RESOLVER, TRUSTED_STATION_CONTEXT_RESOLVER]',
      ),
    },
  },
  {
