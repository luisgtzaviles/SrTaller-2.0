...
test('every Repairs HTTP endpoint belongs to the exact closed authorization matrix', () => {
  assert.deepEqual(registeredRepairRoutes(), [
    ...
    { handler: 'deleteRepairBrand', method: 'DELETE', path: 'configuration/catalogs/brands/:brandId' },
    ...
    { handler: 'deleteRepairDeviceType', method: 'DELETE', path: 'configuration/catalogs/device-types/:deviceTypeId' },
    ...
    { handler: 'deleteRepairModel', method: 'DELETE', path: 'configuration/catalogs/models/:modelId' },
    ...
    { handler: 'deleteRepairRisk', method: 'DELETE', path: 'configuration/catalogs/risks/:riskId' },
