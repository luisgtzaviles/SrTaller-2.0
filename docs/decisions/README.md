...
**Estado:** Propuesta de workflow.
**Decisiones aceptadas:** ninguna.

## Estados permitidos

- `Proposed`: alternativa documentada, pendiente de evaluación y aprobación.
- `Accepted`: aprobada por la autoridad definida; todavía no se usa en esta fundación.
...
| [ADR-002](proposed/ADR-002-modular-monolith-first.md) | Monolito modular primero | Proposed |
