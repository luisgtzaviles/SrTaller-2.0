...
|---|---|---|
| [DEC-004](dec-004-toolchain-contract/DECISION_PROPOSAL.md) | Contrato de toolchain reproducible | Accepted — Selection Approved / Evidence Pending — 2026-07-22 |
...
| [DEC-051](dec-051-testing-ci-strategy/DECISION_PROPOSAL.md) | Estrategia de pruebas, CI y gates ejecutables | Accepted — 2026-07-24 — Responsable del Proyecto; cinco `PASS WITH CONDITIONS`; DEC051-C01 a C10 vigentes y pendientes |
| [DEC-063](dec-063-definition-of-done/DECISION_PROPOSAL.md) | Definition of Done por tipo de trabajo y riesgo | Accepted with conditions — 2026-07-24 — Responsable del Proyecto; cinco `PASS WITH CONDITIONS`; DEC063-C01 a C08 vigentes y pendientes |
