...
**Sprint activo:** Sprint 01; PBI-027 es `Done candidate` pendiente de cierre
documental. PBI-029 está seleccionado, no iniciado ni autorizado.
...
tiene cierre candidato; PBI-029 es el siguiente candidato, todavía no `Ready`
de implementación, no iniciado y no autorizado.
...
En Owner merge review del cierre documental PBI-027.
