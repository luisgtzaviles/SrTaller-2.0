...
PBI-025/PBI-034/PBI-026/PBI-028 están `Done`; G5 es `PASS`, PBI-038 es Current
PBI y WIP es `1/1`.
...
PR #39 y su CI exacta; PBI-038 es el único PBI actual.
...
Al completar candidate CI y focused review de PBI-038.
