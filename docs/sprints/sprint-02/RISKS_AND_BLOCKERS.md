...
- **Estado:** Active; PBI-025 Done; PBI-034 In progress; WIP 1/1.
...
| Session/identity bajo autoridad del frontend | Critical | contexto y Session server-side; bearer opaco HttpOnly, CSRF/origin y revalidación | In progress PBI-034 |
| Bypass por composición modular | High | DEC-005 Option A sólo por aristas explícitas y contratos públicos; checker/mutations fail-closed | In progress PBI-034 |
...
- **Fecha:** al cambiar el threat model o completar el candidato PBI-034.
