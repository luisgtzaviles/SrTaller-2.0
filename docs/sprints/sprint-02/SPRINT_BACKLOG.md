...
| 4 | [PBI-028](../../backlog/pbis/PBI-028.md) | In progress — hardened local candidate | Large / High; DoR PASS, threat model y Owner Start completos; full verify/PostgreSQL/OCI local GREEN; Draft PR, CI y focused review pendientes; único WIP |
...
- **Disparador:** completar el walkthrough PIN-sensitive, Draft PR, focused
  High-risk review, CI exacto o una contradicción material en WIP, orden,
