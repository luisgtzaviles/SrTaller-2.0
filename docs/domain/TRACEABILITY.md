...
| QUESTION-006–012 | DQ-002/003/025/031 | Branch/UserSession/Access | RULE-021 | INV-002/008/010 | Orden confinada; contexto, identidad, sesión y autorización ordinaria aceptados | intención técnica TBD | evento de contexto TBD | SCENARIO-020 | TBD | ADR-004, ADR-010, ADR-011 y ADR-012 Accepted | prueba de aislamiento/contexto/sesión/autorización pendiente |
...
| PBI-008/009 | Identidad, sucursales y estación autorizada | separación de actores/estación y RULE-021 | Contexto aceptado por ADR-010, identidad/PIN/sesión por ADR-011 y autorización ordinaria por ADR-012; mecanismos abiertos |
