...
| QUESTION-006–012 | DQ-002/003/025/031 | Branch/UserSession/Access | RULE-021 | INV-002/008/010 | Contexto, identidad, sesión y autorización ordinaria/reforzada aceptados | intención técnica TBD | evento de contexto TBD | SCENARIO-020 | TBD | ADR-004/010/011/012/013 Accepted | aplicación y prueba pendientes |
...
| PBI-008/009 | Identidad, sucursales y estación autorizada | separación de actores/estación y RULE-021 | ADR-010 contexto, ADR-011 identidad/sesión, ADR-012 autorización ordinaria y ADR-013 refuerzo; mecanismos abiertos |
...
| [ADR-010 — Contexto operativo derivado de estación vinculada](../decisions/proposed/ADR-010-station-bound-operational-context.md) | Decisión aceptada por el Responsable de Producto, 2026-07-21 | estación vinculada, tenant/sucursal derivados, usuario por tenant, cambio de turno y atribución contextual | QUESTION-007–012, DQ-002/031, RULE-021, INV-002/008/010, FOT-DEC-018–020 | Autoritativo para contexto operativo; identidad/sesión se rigen por ADR-011 y autorización por ADR-012 |
| [ADR-011 — Identidad, autenticación por PIN y sesión operativa](../decisions/proposed/ADR-011-tenant-user-pin-authentication-and-operational-session.md) | Decisión aceptada por el Responsable de Producto, 2026-07-21; parcialmente sustituida por ADR-014 | identidad ordinaria, PIN contextual, autenticación, lifecycle e inactividad | QUESTION-009/012, DQ-003/006/025, RULE-021, INV-008/010, FOT-DEC-018–020 | Autoritativo salvo exclusividad/reemplazo station-wide |
| [ADR-014 — Sesiones operativas concurrentes](../decisions/proposed/ADR-014-concurrent-operational-sessions.md) | Decisión aceptada por Product Owner, 2026-09-12 | cero o más Sessions por Station; actor por Session solicitante; switch local | ASC-001–008, PBI-043 | Autoritativo para cardinalidad, switch, lockout y revocación efectiva; implementación pendiente |
| [ADR-012 — Roles de tenant, capacidades y autorización contextual](../decisions/proposed/ADR-012-tenant-roles-capabilities-and-contextual-authorization.md) | Decisión aceptada por el Responsable de Producto, 2026-07-21 | roles, asignaciones, unión de capacidades, alcance, revocación y autorización negativa server-side | QUESTION-007/010/012, RULE-021, INV-010, FOT-PREG-015/033 | Autoritativo para autorización ordinaria; composición por rebanada, acciones sensibles y auditoría técnica permanecen separados |
| [ADR-013 — Acciones sensibles y autorización reforzada](../decisions/proposed/ADR-013-sensitive-actions-and-reinforced-authorization.md) | Decisión aceptada por el Responsable de Producto, 2026-07-21 | niveles 1–4, reautenticación, segundo aprobador, segregación, un solo uso e invalidación | QUESTION-004/012, RULE-021, INV-010, FOT-PREG-015/016 | Autoritativo para refuerzo conceptual; clasificación por rebanada, mecanismo y auditoría técnica permanecen separados |
