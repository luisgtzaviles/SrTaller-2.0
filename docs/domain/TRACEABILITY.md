...
| [ADR-014 — Sesiones operativas concurrentes](../decisions/proposed/ADR-014-concurrent-operational-sessions.md) | Decisión aceptada por Product Owner, 2026-09-12 | cero o más Sessions por Station; actor por Session solicitante; switch local | ASC-001–008, PBI-043 | Autoritativo y materializado por PR #47 / `aab27d9`; CI y Preview PASS |
