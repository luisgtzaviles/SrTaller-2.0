...
| Acción sensible | Operación cuyo efecto o riesgo exige control adicional a una capacidad ordinaria. | acción crítica | toda operación protegida o administrativa | Una devolución candidata permanece en nivel 4 hasta tener política. | D | ADR-013 |
| Reautenticación | Nueva comprobación de la identidad del actor activo para una acción sensible. | confirmar PIN | cambio de turno, segundo usuario o elevación | El actor confirma nuevamente su identidad antes de una operación nivel 2. | D | ADR-013 |
| Aprobador | Segundo usuario diferente con capacidad específica para aprobar la acción delimitada. | supervisor | actor principal, rol o puesto | Otra identidad aprueba una operación nivel 3. | D | ADR-013 |
| Autorización reforzada | Control adicional nivel 2 o 3, limitado y de un solo uso por defecto. | step-up, doble control | autorización ordinaria o auditoría | La aprobación se consume con la operación aceptada. | D | ADR-013 |
