...
Este documento describe responsabilidades de negocio, no concede capacidades. [ADR-012](../../decisions/proposed/ADR-012-tenant-roles-capabilities-and-contextual-authorization.md) gobierna roles/capacidades y [ADR-013](../../decisions/proposed/ADR-013-sensitive-actions-and-reinforced-authorization.md) reautenticación, segundo aprobador y segregación. Quedan abiertas composición, clasificación por rebanada y mecanismos.
