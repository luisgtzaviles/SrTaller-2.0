...
|---|---|---|
| UBIQUITOUS_LANGUAGE: sesión operativa/PIN | el mecanismo legacy y su propósito de baja fricción quedan validados; controles siguen abiertos | promover con límites de atribución |
