...
| `FSR-ACTOR-007` | Supervisor de recepción | Autorizar una excepción candidata y responder por pendientes. | No debe convertirse en aprobación automática. | `Pending Product Owner validation` |
