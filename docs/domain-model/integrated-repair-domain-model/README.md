...
- [ADR-011 — Identidad, autenticación por PIN y sesión operativa](../../decisions/proposed/ADR-011-tenant-user-pin-authentication-and-operational-session.md), `Accepted` el 2026-07-21. Fija identidad ordinaria, propósito del PIN, autenticación contextual, una sesión activa por estación y atribución con sesión; no decide permisos ni mecanismos técnicos.
