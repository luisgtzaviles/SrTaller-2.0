...
`Released: NO`. SPRINT-02 está `Active`; no hay PBI actual y el WIP es `0/1`.
...
| [PBI-026](PBI-026.md) | Contextual Authorization | Selected candidate; not started |
...
| [PBI-034](PBI-034.md) | Operational Session | Done candidate; functional integration/main CI/acceptance PASS; Released: NO |
...
Merge autorizado y CI exacto del cierre PBI-034. PBI-026 no inicia antes de su cierre
canónico.
