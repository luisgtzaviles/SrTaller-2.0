...
**Estado:** Índice reconciliado con `main` funcional `09e14c8` y CI exacta
`34809054770`. SPRINT-02 está `Closed` y PBI-043 `Done`. SPRINT-03 está
`Active`: PBI-040 es `Done candidate`, no existe Current PBI, PBI-041 está
Ready/Not authorized y PBI-042 Planned/Unassigned. WIP `0/1`.
...
| [PBI-040](PBI-040.md) | Catalog & Pricing Core + Fast Price Lookup | Done candidate; Released: NO |
...
PBI-040 espera sólo el merge/CI de su cierre documental. No iniciar
PBI-041/PBI-042 ni autorizar implementación o deploy por inferencia.
