...
`Active`, PBI-025 es el único PBI actual, `In progress`, con riesgo `Critical`,
estimación `Large`, DoR `PASS` y WIP `1/1`. PBI-034 es el siguiente candidato,
no iniciado.
...
inicia antes de su cierre canónico.
