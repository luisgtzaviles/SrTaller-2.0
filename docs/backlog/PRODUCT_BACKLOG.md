...
| 27 | [PBI-027](pbis/PBI-027.md) Branch Timezone Minimum | Architecture / Product | EPIC-001 | In progress; DoR PASS; Small / Medium | Alta | Current PBI Sprint 01; local-only until Owner Review |
...
- PBI-027 tiene decisión de Branch timezone resuelta, DoR `PASS` y está en
  implementación local autorizada. Su siguiente gate es Owner Review; merge y
  deploy permanecen fuera de alcance.
