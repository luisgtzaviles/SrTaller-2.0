...
limitada y está `Ready` tras el PASS material de SPIKE-002; PBI-024–PBI-029
...
| 23 | [PBI-023](pbis/PBI-023.md) Establish tenant-scoped persistence and migration foundation | Persistence / Security / Quality | EPIC-001 | Ready; transaction runner verified / migration runner authorized | Crítica | Gate R0 |
...
- PBI-023–PBI-029 no están en un sprint de implementación. PBI-023 conserva
  autorización limitada y planificación completa, pero no puede iniciar
  materialización productiva hasta satisfacer cada gate; SPIKE-002 ya cerró.
...
Autorización y cierre del checker/boundaries de PBI-023.
