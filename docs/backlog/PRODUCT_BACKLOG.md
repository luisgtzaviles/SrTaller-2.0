...
son trabajos técnicos posteriores terminados; PBI-023 conserva autorización
limitada y está `Ready` tras verificar el schema tenant mínimo; PBI-024–PBI-029
forman la descomposición no autorizada del resto de H1.
...
| 23 | [PBI-023](pbis/PBI-023.md) Establish tenant-scoped persistence and migration foundation | Persistence / Security / Quality | EPIC-001 | Ready; tenant schema verified / owner-scoped adapters authorized | Crítica | Gate R0 |
...
- PBI-023–PBI-029 no están en un sprint de implementación. PBI-023 conserva
  autorización limitada y schema mínimo verificado; el siguiente cambio
  requiere autorización separada para adapters owner-scoped.
...
Revisión y autorización del Paso 10 owner-scoped adapters de PBI-023.
