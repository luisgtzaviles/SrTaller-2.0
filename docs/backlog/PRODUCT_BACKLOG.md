...
limitada pero está bloqueado por SPIKE-002 ejecutable; PBI-024–PBI-029 forman
la descomposición no autorizada del resto de H1.
...
| 23 | [PBI-023](pbis/PBI-023.md) Establish tenant-scoped persistence and migration foundation | Persistence / Security / Quality | EPIC-001 | Blocked; planning complete, SPIKE-002 ejecutable pendiente | Crítica | Gate R0 |
...
- PBI-023–PBI-029 no están en un sprint de implementación. PBI-023 conserva
  ...
  materialización hasta cerrar SPIKE-002.
...
Cierre ejecutable y revisión de SPIKE-002.
