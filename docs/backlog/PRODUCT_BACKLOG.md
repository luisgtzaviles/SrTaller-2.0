...
| 27 | [PBI-027](pbis/PBI-027.md) Branch Timezone Minimum | Architecture / Product | EPIC-001 | Done candidate; DoR PASS; Small / Medium; merge, CI main y Acceptance PASS | Alta | Cierre documental Sprint 01 pendiente de merge |
...
- PBI-027 tiene decisión de Branch timezone resuelta, DoR `PASS`, merge
