...
- **Estado:** PBI-023 `Closed`; Identity & Context Foundation cerrada en
  Sprint 01. SPRINT-02 está `Active`, PBI-034/PBI-026 están `Done`, PBI-028
  está `Done candidate`, Current PBI es `NONE` y WIP es `0/1`.
...
- **Actualización:** [PBI-021](pbis/PBI-021.md) y
  ...
  PBI-032/PBI-033/PBI-025/PBI-034/PBI-026 están `Done`; PBI-028 está `Done
  candidate`, con riesgo High preservado y tamaño Large.
...
- **Estado:** User Directory y Roles/Capabilities/Assignments `Done`; G2
  ...
  PBI-025/PBI-034/PBI-026 están `Done`, G4 `PASS`; PBI-028 está `Done
  candidate`, G5 `PASS candidate` y el WIP es `0/1`.
