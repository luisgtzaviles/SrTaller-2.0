...
- **Estado:** PBI-023 `Closed`; Identity & Context Foundation cerrada en
  Sprint 01. SPRINT-02 está `Active`, PBI-034 está en `Done candidate`, no hay
  PBI actual y WIP es `0/1`.
...
- **Actualización:** [PBI-021](pbis/PBI-021.md) y
  ...
  PBI-032/PBI-033/PBI-025 están `Done`; PBI-034 está en `Done candidate`, con
  riesgo Critical preservado y tamaño Large.
...
- **Estado:** User Directory y Roles/Capabilities/Assignments `Done`; G2
  ...
  PBI-025 está `Done`; PBI-034 está en `Done candidate`, no hay PBI actual y
  el WIP es `0/1`.
