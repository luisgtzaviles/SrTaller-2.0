...
- **Estado:** PBI-023 `Closed`; Identity & Context Foundation cerrada en
  Sprint 01. SPRINT-02 está `Active`, PBI-034 está `Done`, PBI-026 queda
  `Done candidate`, no existe PBI actual y WIP es `0/1`.
...
- **Actualización:** [PBI-021](pbis/PBI-021.md) y
  ...
  PBI-032/PBI-033/PBI-025/PBI-034 están `Done`; PBI-026 queda `Done candidate`,
  con riesgo Critical preservado, tamaño Large y cierre pendiente.
...
- **Estado:** User Directory y Roles/Capabilities/Assignments `Done`; G2
  ...
  PBI-025/PBI-034 están `Done`; PBI-026 queda `Done candidate`, G4
  `PASS candidate` y el WIP es `0/1`.
