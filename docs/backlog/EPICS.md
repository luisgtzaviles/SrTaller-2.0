...
- **Estado:** PBI-023 `Closed`; Identity & Context Foundation cerrada en
  ...
  está `In progress` como PBI actual y WIP es `1/1`.
...
- **Actualización:** [PBI-021](pbis/PBI-021.md) y
  ...
  PBI-032/PBI-033/PBI-025/PBI-034/PBI-026 están `Done`; PBI-028 está `In
  progress`, con riesgo High preservado y tamaño Large.
...
- **Estado:** User Directory y Roles/Capabilities/Assignments `Done`; G2
  ...
  PBI-025/PBI-034/PBI-026 están `Done`, G4 `PASS`; PBI-028 está `In progress`
  y el WIP es `1/1`.
