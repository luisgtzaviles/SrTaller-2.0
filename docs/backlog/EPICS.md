...
- **Estado:** PBI-023 `Closed`; Identity & Context Foundation cerrada en
  Sprint 01. SPRINT-02 está `Active`, PBI-034 está `Done`, PBI-026 es el PBI
  actual y WIP es `1/1`.
...
- **Actualización:** [PBI-021](pbis/PBI-021.md) y
  ...
  PBI-032/PBI-033/PBI-025/PBI-034 están `Done`; PBI-026 está `In progress`,
  con riesgo Critical preservado y tamaño Large.
...
- **Estado:** User Directory y Roles/Capabilities/Assignments `Done`; G2
  ...
  PBI-025/PBI-034 están `Done`; PBI-026 está `In progress` y el WIP es `1/1`.
