...
| Lógica de negocio en controladores | Alta / alta | Reglas repetidas por entrada | Dominio/aplicación y pruebas | Primer cambio de código | R |
...
| Dependencias circulares | Media / alta | Importaciones/llamadas bidireccionales | Orquestación y contratos | Primer cambio de código | R |
| Eventos indiscriminados | Media / media | Cada cambio publica y encadena | Evento sólo con valor/consumidor | Por rebanada | R |
| Trazabilidad incompleta | Alta / alta | Acciones sin actor/tiempo | Contrato transversal y auditoría | Primer cambio de código | R |
...
| Permisos sólo en interfaz | Alta / crítica | API interna acepta acción oculta | Autorización en aplicación | Primer cambio de código | R |
...
| Núcleo compartido creciente | Media / alta | Reglas de negocio en “Común” | Núcleo mínimo y estable | Primer cambio de código | R |
