...
| Acciones sensibles | Frontera capacidad ordinaria + control reforzado reconocida | Catálogo y mecanismo reforzado pendientes | PB |
...
| ADRs | ADR-002, ADR-004, ADR-010, ADR-011 y ADR-012 aceptados; ADR-001, ADR-003 y ADR-005 a ADR-009 siguen propuestos | Forma, tenancy, contexto, identidad/sesión y autorización ordinaria definidos; conjunto tecnológico aún bloqueante | PB |
...
- **[R]** Flujos sensibles antes de acordar control reforzado, atribución y evidencia.
