...
**Preparado con bloqueantes.** Existe suficiente definición del dominio para delimitar el MVP, proponer fronteras y ordenar rebanadas verticales. ADR-004 acepta topología/propiedad multitenant y ADR-010 acepta el contexto operativo por estación, pero todavía no existe autorización explícita para implementar y permanecen decisiones mínimas sobre plataforma, evidencia de aislamiento, identidad/PIN, permisos, estados, folios, configuración, autorización comercial, calidad y entrega.
...
**[PB]** Autorización para implementar; ADRs técnicos restantes; aplicación y pruebas del aislamiento/contexto aceptados; identidad/PIN, sesión y permisos; término oficial; alcance/concurrencia del folio; estados iniciales; política efectiva; archivos, zona horaria y criterios de aceptación. ADR-002, ADR-004 y ADR-010 ya no son decisiones conceptuales bloqueantes. Véase [Decisiones bloqueantes](DECISIONES_BLOQUEANTES.md).
...
- [ADR-002](../../decisions/proposed/ADR-002-modular-monolith-first.md), [ADR-004](../../decisions/proposed/ADR-004-shared-schema-multitenancy.md) y [ADR-010](../../decisions/proposed/ADR-010-station-bound-operational-context.md) están `Accepted`; los demás ADRs conservan el estado del [registro](../../decisions/README.md).
...
**[ADR]** ADR-004 fija la topología multitenant y ADR-010 el contexto efectivo por estación. Lenguaje, marcos, motor, RLS y mecanismos técnicos de identidad/sesión sólo podrán fijarse mediante sus decisiones aceptadas.
