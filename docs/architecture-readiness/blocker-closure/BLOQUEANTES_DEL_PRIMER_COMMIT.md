...
**No puede comenzar código funcional del producto.** [PBI-022](../../backlog/pbis/PBI-022.md) quedó `Done`, DEC-005 formalmente verificada y VC-024 `Closed / PASS`; esos cierres no amplían la autorización. Continúan permitidos documentación, refinamiento, diseño de ADRs y preparación no ejecutada de experimentos bajo sus autoridades propias.
...
| DEC-004 | Contrato de toolchain reproducible | `Accepted — VC-024 Closed / PASS` | [Dos jobs Linux y comparación reproducible](../dec-004-linux-verification/vc-024/FORMAL_VERIFICATION.md); cerrado para H0 |
...
| [DEC-051](../../decisions/dec-051-testing-ci-strategy/FORMAL_REVIEW.md) | Estrategia de pruebas, CI y gates ejecutables | `Accepted` el 2026-07-24; C01/C07/C09 `Satisfied`, restantes `Pending` | Cerrado para H0; protección de `main`, PostgreSQL real y condiciones restantes continúan pendientes |
...
| [DEC-063](../../decisions/dec-063-definition-of-done/FORMAL_REVIEW.md) | Definición de terminado | `Accepted with conditions` el 2026-07-24; C01/C03/C04 `Satisfied`, restantes `Pending` | Cerrado para H0; clasificación de riesgo y checklists especializados continúan pendientes |
...
- DEC-004 acepta Node.js `24.18.0`, pnpm `11.15.1`, ESM/NodeNext, TypeScript
  `6.0.3`, compilación previa y Linux x86_64/glibc; VC-024 declara evidencia
  reproducible, pero no autoriza funcionalidad.
