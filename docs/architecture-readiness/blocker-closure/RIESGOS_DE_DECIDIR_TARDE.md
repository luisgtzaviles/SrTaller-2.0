...
| DEC-010 a DEC-012 | La sucursal activa se infiere o se muta silenciosamente | Atribución, visibilidad y políticas aplicadas al lugar equivocado | Crítica | Antes del primer caso de uso con sucursal | Registrar escenarios de ausencia/cambio y no elegir default implícito |
