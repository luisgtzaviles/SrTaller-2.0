...
| DEC-063 | Cerrada el 2026-07-24; el riesgo pasa a no materializar sus condiciones | Checklists, riesgo, evidencia o waivers aplicados de forma inconsistente | Crítica | Antes del trigger de cada condición | Materializar DEC063-C01 a C08 sólo con autorización y evidencia |
