...
| DEC-050 a DEC-054 | [arquitectura de datos](../../architecture/DATA_ARCHITECTURE.md), [DEC-051](../../decisions/dec-051-testing-ci-strategy/FORMAL_REVIEW.md), [riesgos](../repair-mvp/RIESGOS_ARQUITECTONICOS.md) | [estado de preparación](../repair-mvp/ESTADO_DE_PREPARACION_ARQUITECTONICA.md), [testing](../../quality/TESTING_STRATEGY.md), [aislamiento](../../quality/MULTITENANT_ISOLATION_TESTING.md) | DEC-051 está `Accepted` con C01 a C10 pendientes; migraciones, fixtures, ejecución y recuperación siguen como gates |
