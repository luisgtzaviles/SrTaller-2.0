...
| --- | --- | --- | --- |
| DEC-001, DEC-005, DEC-049, DEC-071 | [ADR-002](../../decisions/proposed/ADR-002-modular-monolith-first.md), [monolito modular](../repair-mvp/MONOLITO_MODULAR.md) | [propuesta DEC-005](../../decisions/dec-005-modular-monolith-organization/DECISION_PROPOSAL.md), [dictamen](../../decisions/dec-005-modular-monolith-organization/FORMAL_REVIEW.md), [resultado](../../decisions/dec-005-modular-monolith-organization/RESULTS.md), [PBI-022](../../backlog/pbis/PBI-022.md), [sexta verificación](../dec-005-materialization/FORMAL_VERIFICATION_6.md), [DEC-049](../../decisions/dec-049-persistence-ownership/DECISION_PROPOSAL.md), [revisión DEC-049](../../decisions/dec-049-persistence-ownership/FORMAL_REVIEW.md), [fronteras](../repair-mvp/FRONTERAS_MODULARES_PROPUESTAS.md) | DEC-005 `Accepted — Materialized / Formally Verified`; PBI-022 `Done`; DEC-049 `Accepted`, sin materialización y con DEC049-C01 a C08 vigentes |
| DEC-002, DEC-003, DEC-062, DEC-063 | [criterios de salida de R0](CRITERIOS_DE_SALIDA_DE_R0.md), [alcance MVP](../repair-mvp/ALCANCE_DEL_MVP.md), [rebanadas](../repair-mvp/PLAN_DE_REBANADAS_VERTICALES.md) | [criterios de implementación](../repair-mvp/CRITERIOS_DE_INICIO_DE_IMPLEMENTACION.md), [flujo mínimo](../repair-mvp/FLUJO_VERTICAL_MINIMO_VENDIBLE.md), [DEC-063](../../decisions/dec-063-definition-of-done/FORMAL_REVIEW.md) | DEC-002/062 cerradas para R0 el 2026-07-21; DEC-063 aceptada con C01/C03/C04 `Satisfied` y restantes `Pending`; DEC-003 y ejecución funcional siguen pendientes |
| DEC-004 | [registro canónico](DEC-004_BASELINE_TECNICA.md), ADR-[001](../../decisions/proposed/ADR-001-typescript-as-primary-language.md), [003](../../decisions/proposed/ADR-003-postgresql-primary-database.md), [005](../../decisions/proposed/ADR-005-nestjs-backend.md), [009](../../decisions/proposed/ADR-009-monorepo-strategy.md) | [PBI-021](../../backlog/pbis/PBI-021.md), [revisión formal](../../decisions/dec-004-toolchain-contract/FORMAL_REVIEW.md), [contrato de verificación](../../decisions/dec-004-toolchain-contract/VERIFICATION_CONTRACT.md), [VC-024](../dec-004-linux-verification/vc-024/FORMAL_VERIFICATION.md) | `Accepted — VC-024 Closed / PASS`; evidencia Linux y reproducibilidad final verificadas |
...
| DEC-050 a DEC-054 | [DEC-050](../../decisions/dec-050-migration-strategy/DECISION_PROPOSAL.md), [arquitectura de datos](../../architecture/DATA_ARCHITECTURE.md), [DEC-051](../../decisions/dec-051-testing-ci-strategy/FORMAL_REVIEW.md), [riesgos](../repair-mvp/RIESGOS_ARQUITECTONICOS.md) | [expediente PBI-023](../pbi-023/README.md), [testing](../../quality/TESTING_STRATEGY.md), [aislamiento](../../quality/MULTITENANT_ISOLATION_TESTING.md) | DEC-050 `Accepted with conditions`; DEC-051 `Accepted` con C01/C07/C09 `Satisfied`; SPIKE-002 material `PASS`; fixtures, ejecución y recuperación siguen como gates |
...
- al crear este paquete no se creó ni aceptó ningún ADR; ADR-001, ADR-003, ADR-004, ADR-005, ADR-009 y ADR-010 a ADR-013 fueron aceptados posteriormente y se registran como actualizaciones trazables;
...
- SPIKE-009 fue ejecutado posteriormente y queda trazado como evidencia desechable aceptada con condiciones no bloqueantes; los demás spikes conservan su estado;
