...
| DEC-050 a DEC-054 | [DEC-050](../../decisions/dec-050-migration-strategy/DECISION_PROPOSAL.md), [arquitectura de datos](../../architecture/DATA_ARCHITECTURE.md), [DEC-051](../../decisions/dec-051-testing-ci-strategy/FORMAL_REVIEW.md), [riesgos](../repair-mvp/RIESGOS_ARQUITECTONICOS.md) | [expediente PBI-023](../pbi-023/README.md), [testing](../../quality/TESTING_STRATEGY.md), [aislamiento](../../quality/MULTITENANT_ISOLATION_TESTING.md) | DEC-050 `Accepted with conditions`; DEC-051 `Accepted` con C01/C07/C09 `Satisfied`; SPIKE-002, fixtures, ejecución y recuperación siguen como gates |
