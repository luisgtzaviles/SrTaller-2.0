...
| DEC-006 a DEC-012 | [modelo multitenant](../repair-mvp/MODELO_MULTITENANT.md), [ADR-004](../../decisions/proposed/ADR-004-shared-schema-multitenancy.md) | [multitenancy transversal](../../architecture/MULTITENANCY_MODEL.md), [branch/device](../../architecture/BRANCH_AND_DEVICE_MODEL.md) | Aislamiento, ownership y preguntas tenant/sucursal |
...
- no se creó ni aceptó ningún ADR;
