...
| DEC-013 a DEC-020 | [identidad y atribución](../repair-mvp/MODELO_DE_IDENTIDAD_Y_ATRIBUCION.md), [seguridad](../repair-mvp/SEGURIDAD_Y_ACCIONES_SENSIBLES.md) | [ADR-010](../../decisions/proposed/ADR-010-station-bound-operational-context.md), [identidad/permisos](../../architecture/IDENTITY_ACCESS_AND_PERMISSIONS.md), [baseline](../../architecture/SECURITY_BASELINE.md) | Usuario/contexto y atribución mínima aceptados; identidad técnica, PIN, sesión, autorización y acciones sensibles continúan |
...
- al crear este paquete no se creó ni aceptó ningún ADR; ADR-004 y ADR-010 fueron aceptados posteriormente y se registran como actualizaciones trazables;
