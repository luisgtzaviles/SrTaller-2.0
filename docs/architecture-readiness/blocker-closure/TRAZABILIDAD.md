...
| DEC-006 a DEC-012 | [ADR-004 Accepted](../../decisions/proposed/ADR-004-shared-schema-multitenancy.md), [modelo multitenant](../repair-mvp/MODELO_MULTITENANT.md) | [multitenancy transversal](../../architecture/MULTITENANCY_MODEL.md), [sucursal/dispositivo](../../architecture/BRANCH_AND_DEVICE_MODEL.md) | Topología y propiedad lógica aceptadas; contexto operativo tenant/sucursal sigue separado |
| DEC-013 a DEC-020 | [identidad y atribución](../repair-mvp/MODELO_DE_IDENTIDAD_Y_ATRIBUCION.md), [seguridad](../repair-mvp/SEGURIDAD_Y_ACCIONES_SENSIBLES.md) | [identidad/permisos](../../architecture/IDENTITY_ACCESS_AND_PERMISSIONS.md), [baseline](../../architecture/SECURITY_BASELINE.md) | Identidad, PIN, sesión, autorización y acciones sensibles |
...
- al crear este paquete no se creó ni aceptó ningún ADR; ADR-004 fue aceptado posteriormente y se registra como actualización trazable;
