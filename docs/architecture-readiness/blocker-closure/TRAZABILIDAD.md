...
- al crear este paquete no se creó ni aceptó ningún ADR; ADR-001, ADR-003, ADR-004, ADR-009 y ADR-010 a ADR-013 fueron aceptados posteriormente y se registran como actualizaciones trazables;
