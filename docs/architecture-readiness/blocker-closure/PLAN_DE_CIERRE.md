...
| 8 | DEC-013 a DEC-016 | Producto + Seguridad | Actores y contexto aceptado | Autenticación, protección del PIN, sesión, inactividad técnica y atribución detallada | ADR nuevo de identidad/sesión | Usuario y contexto se reconstruyen sin confiar en entrada manipulable | H1 |
