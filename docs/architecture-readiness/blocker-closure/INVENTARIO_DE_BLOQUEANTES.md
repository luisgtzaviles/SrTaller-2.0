...
| DEC-004 | Stack de aplicación | Parcial: ADR-001 Accepted; ADR-003/005/009 Proposed | H0 | Alta | DEC-001, DEC-002 | ADR-001, ADR-003, ADR-005 y ADR-009 | Arquitectura + Ingeniería | ADRs aceptados y restricciones verificadas | Rehacer runtime, persistencia o repositorio |
