...
| DEC-002 | Alcance exacto de R0 | Cerrada por decisión de Producto (2026-07-21) | H0 cerrado para alcance | Crítica | Alcance del MVP | No | Producto + Arquitectura | Fundación ejecutable, inclusiones, exclusiones y demostración aprobadas | Controlar que implementación y R1 no amplíen el alcance |
...
| DEC-004 | Stack de aplicación | Parcial: ADR-001/003 Accepted; ADR-005/009 Proposed | H0 | Alta | DEC-001, DEC-002 | ADR-001, ADR-003, ADR-005 y ADR-009 | Arquitectura + Ingeniería | Motor/lenguaje aceptados; framework y repositorio pendientes | Rehacer runtime, framework o repositorio |
...
| DEC-019 | Acciones sensibles | Aceptada conceptualmente en ADR-013 | H1: falta clasificar/aplicar/probar por rebanada | Crítica | DEC-018, procesos incluidos | ADR-013 Accepted | Producto + Seguridad | Definición, niveles, deny-by-default, motivo y evidencia mínima aceptados; falta política concreta por acción | Fraude, bypass o excepciones invisibles |
| DEC-020 | Reautenticación | Aceptada conceptualmente en ADR-013 | H1: falta mecanismo/aplicación/pruebas | Alta | DEC-014, DEC-019 | ADR-013 Accepted | Producto + Seguridad | Reautenticación, segundo aprobador, un solo uso, segregación e invalidación aceptados; factores y tiempos siguen abiertos | PIN/sesión insuficientes para cambios críticos |
...
| DEC-050 | Migraciones y versionado de esquema | Abierta; principios aceptados en ADR-003, tooling pendiente | H1 | Crítica | DEC-004, DEC-006 | ADR-003 Accepted + decisión de tooling/ejecución | Arquitectura + Ingeniería + Operaciones | Herramienta, compatibilidad, rollback/roll-forward y prueba | Esquema irrepetible o despliegue inseguro |
...
| DEC-062 | Criterios de aceptación | Cerrada para R0 por decisión de Producto (2026-07-21) | H0 cerrado para R0; se redefine por cada rebanada | Crítica | Alcance y escenarios | No | Producto + Calidad + Arquitectura | Escenarios felices, negativos y de denegación, pruebas, evidencia y autoridad aprobados para R0 | Impedir aceptación visual o sin aislamiento integrado |
