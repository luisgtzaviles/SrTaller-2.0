...
| DEC-013 | Identidad tradicional | Parcialmente resuelta | H1 | Crítica | DEC-006, DEC-008 | ADR de identidad y sesión | Seguridad + Arquitectura | Usuario ordinario por tenant aceptado; faltan autenticación, recuperación y revocación | Cuentas ambiguas o imposibles de revocar |
| DEC-014 | Acceso operativo por PIN | Parcialmente resuelta | H1 | Crítica | DEC-013, DEC-010, acciones sensibles | ADR de identidad y sesión | Producto + Seguridad + Operaciones | PIN identifica dentro del tenant; faltan límites, modelo de amenazas y experimento autorizado | PIN tratado como identidad o permiso universal |
| DEC-015 | Cierre por inactividad | Parcialmente resuelta | H1 | Alta | DEC-014, riesgo operativo | ADR de identidad y sesión | Producto + Seguridad + Operaciones | Cierra usuario y conserva estación; faltan duración, reanudación y prueba | Atribución al usuario anterior |
| DEC-016 | Atribución de acciones | Parcialmente resuelta | H1 | Crítica | DEC-013 a DEC-015, DEC-046 | ADR-010 Accepted + ADR de auditoría | Producto + Seguridad + Arquitectura | Contexto mínimo aceptado; faltan política, integridad, retención y pruebas | Acciones sin responsable verificable |
