...
| DEC-006 | Estrategia multitenant | Propuesta | H1 | Crítica | DEC-008, DEC-009, DEC-049 | Ampliar/revisar ADR-004 | Arquitectura + Seguridad | Alternativas, threat model, spike y decisión aceptada | Fuga cross-tenant o persistencia difícil de rehacer |
| DEC-007 | Propiedad de datos por tenant | Parcialmente resuelta | H1 | Crítica | DEC-006, DEC-008, DEC-049 | Parte de ADR multitenant/datos | Arquitectura + Producto | Matriz dato global, tenant y sucursal | Datos sin dueño o alcance ambiguo |
| DEC-008 | Datos globales del SaaS | Requiere Product Owner | H1 | Crítica | Ciclo del tenant, DEC-006 | Parte de ADR multitenant | Producto + Arquitectura | Catálogo explícito de datos globales y autoridad | Omisión accidental de tenant o supertenant implícito |
| DEC-009 | Contexto explícito de tenant | Parcialmente resuelta | H1 | Crítica | DEC-006, identidad | Parte de ADR multitenant | Arquitectura + Seguridad | Contrato inmutable, fuentes confiables y pruebas negativas | Contexto manipulable o contaminación entre operaciones |
| DEC-010 | Sucursal activa | Requiere Product Owner | H1 | Crítica | DEC-007, membresía | ADR de contexto operativo | Producto + Arquitectura | Regla de selección, alcance y ausencia segura | Operación atribuida a sucursal incorrecta |
| DEC-011 | Usuario operando múltiples sucursales | Requiere Product Owner | H1 | Alta | DEC-010, DEC-017 | ADR de contexto operativo | Producto + Seguridad | Casos permitidos, alcance y matriz de visibilidad | Acceso transversal implícito |
| DEC-012 | Cambio de sucursal | Requiere Product Owner | H1 | Alta | DEC-010, DEC-011, sesión | ADR de contexto operativo | Producto + Seguridad + Arquitectura | Flujo, revalidación, auditoría y operaciones abiertas | Contexto mutado silenciosamente |
| DEC-013 | Identidad tradicional | Propuesta | H1 | Crítica | DEC-006, DEC-008 | ADR de identidad y sesión | Seguridad + Arquitectura | Modelo de identidad, membresía, recuperación y revocación | Cuentas ambiguas o imposibles de revocar |
| DEC-014 | Acceso operativo por PIN | Requiere Product Owner | H1 | Crítica | DEC-013, DEC-010, acciones sensibles | ADR de identidad y sesión | Producto + Seguridad + Operaciones | Propósito, límites, threat model y spike autorizado | PIN tratado como identidad o permiso universal |
| DEC-015 | Cierre por inactividad | Requiere Product Owner | H1 | Alta | DEC-014, riesgo operativo | ADR de identidad y sesión | Producto + Seguridad + Operaciones | Conducta por riesgo, reanudación y prueba de estación compartida | Atribución al usuario anterior |
| DEC-016 | Atribución de acciones | Parcialmente resuelta | H1 | Crítica | DEC-013 a DEC-015, DEC-046 | ADR de auditoría/identidad | Producto + Seguridad + Arquitectura | Actor, tenant, sucursal y tiempo obligatorios y probados | Acciones sin responsable verificable |
| DEC-017 | Roles mínimos | Requiere Product Owner | H1 | Alta | Actores de R0, DEC-013 | ADR de roles y permisos | Producto + Seguridad | Roles mínimos como agrupaciones, no puestos rígidos | Roles inventados o privilegios excesivos |
| DEC-018 | Permisos mínimos | Requiere Product Owner | H1 | Crítica | DEC-017, alcance R0 | ADR de roles y permisos | Producto + Seguridad + Arquitectura | Matriz actor, acción, alcance y denegación | Autorización sólo en interfaz |
| DEC-019 | Acciones sensibles | Parcialmente resuelta | H1 y por rebanada | Crítica | DEC-018, procesos incluidos | ADR de roles y permisos | Producto + Seguridad | Catálogo por hito, autoridad, motivo y auditoría | Fraude, bypass o excepciones invisibles |
| DEC-020 | Reautenticación | Requiere Product Owner | H1 | Alta | DEC-014, DEC-019 | ADR de identidad y sesión | Producto + Seguridad | Acciones, vigencia y método reforzado acordados | PIN/sesión insuficientes para cambios críticos |
