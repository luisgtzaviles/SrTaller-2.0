...
Los 98 fixtures reales son 12 positivos y 86 negativos. Cubren las 27 reglas
ejecutadas directamente por el checker; D5-R001 pertenece al verificador
externo de DEC-004, D5-R032/D5-R033 son compuestas y seis reglas son
documentales/no aplicables al árbol sin funcionalidad.

Las 23 mutaciones cubren 12 familias normativas distintas: D5-R003, D5-R005,
...
de texto que omitan la ejecución del checker.

Además, 26 IDs de `requiredSemanticCoverage` fijan las variantes críticas
...
canónica. El total sigue siendo 26 porque todos los contratos vigentes
resultaron únicos. Los fixtures con varios diagnósticos declaran y validan el
conjunto completo de paths, no sólo uno de ellos.

Las 23 mutaciones de producto permanecen en las mismas 12 familias: las seis
guardas semánticas prueban el contrato compuesto D5-R033 y no inventan una
familia de arquitectura adicional para inflar ese conteo.
