...
| C04 | aislamiento, negativas, concurrencia y 25 mutaciones causalmente correlacionadas | PASS material |
...
Los runs `30239752229` y `30239754842` demuestran ejecución real del parser,
casos negativos A–J, regresión de falso positivo y campaña 25/25, sin cambiar
el estado canónico de C02.
