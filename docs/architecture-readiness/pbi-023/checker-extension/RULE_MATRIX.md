...
| D5-R045 | Registered facility API and consumer | Archivo DB exige owner, exports exactos y consumer materializado o transición pura exacta | config pura sin imports; demás facilities registradas/consumidas | path/API/runner/placeholder desconocido o sin consumidor | sólo `database-config.ts` + status/owner/consumerRequirement exactos y cero imports hasta Paso 6 | `mutation:D5-R045:persistence-boundary` |
