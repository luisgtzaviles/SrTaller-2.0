...
| job | `89748256826` — `VC-024 run-2` |
| evento | `push` |
| commit | `9e38f20900e2be4df7680a936fdfee077e6c6950` |
| attempt | `1` |
| inicio/fin | `2026-07-26T02:47:13Z` / `2026-07-26T02:55:23Z` |
| PostgreSQL step | `2026-07-26T02:47:40Z`–`02:48:07Z` |
| resultado | `success` |
...
| job | `89748259601` — `VC-024 run-2` |
| head SHA remoto | `9e38f20900e2be4df7680a936fdfee077e6c6950` |
| artifact commit | `33e886c5bdda06a4f189fd0e0c549930222be873` |
| resultado | `success` |

Run-2 usó contenedores, bases, credenciales, journal y datos independientes de
run-1. El artifact del PR se conserva como evidencia secundaria.
