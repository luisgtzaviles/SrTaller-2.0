...
| orden/immutability | DEC050-C02 | DEC-050 §6.1 | [naming/manifest](migration-runner/MANIFEST_AND_DRIFT.md) | `PASS runner; first product migration pending` |
...
| vacío/anterior/re-run | DEC050-C07, DEC051-C03 | IMPLEMENTATION step 8/10 | [PostgreSQL matrix](migration-runner/POSTGRESQL_TEST_MATRIX.md) | `PASS fixtures local; product migration/CI pending` |
...
| boundaries/checker | DEC-005, DEC051-C06/C09 | IMPLEMENTATION step 3/7/8 | [D5-R049 enforcement](migration-runner/ARCHITECTURE_ENFORCEMENT.md) | `PASS — D5-R037–D5-R049` |
...
conexión, el transaction runner y el migration runner están ejecutados y
cerrados. Su evidencia no sustituye primera migración productiva, PostgreSQL CI
