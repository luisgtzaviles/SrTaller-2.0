...
| plan secuencial | `Ready` | [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md) | siguiente Paso 3 |
...
La planificación y el gate material de SPIKE-002 cumplen Definition of Ready.
El estado correcto es `Ready — SPIKE-002 materially verified /
implementation gates ready`. No significa `In progress`, no satisface las
