...
| [ADR-011](../../decisions/proposed/ADR-011-tenant-user-pin-authentication-and-operational-session.md) + [ADR-014](../../decisions/proposed/ADR-014-concurrent-operational-sessions.md) | PIN tenant-scoped, Sessions concurrentes con actor por Session solicitante y materialización PBI-043 pendiente |
