...
PBI-034 `Done candidate`; no hay PBI actual y WIP operacional es `0/1`. G3 es
`PASS candidate` y PBI-026 está seleccionado, no iniciado.
...
`f3e394b59ec7421e13b36ed6bfddff28e45c0dd7`, run `34150632738`; véase
