...
**Estado:** Sprint 00 `Closed`; Sprint 01 `Active`; PBI-030, PBI-027, PBI-029
y PBI-024 `Done`; PBI-032 `Done candidate`; `Released: NO` para todos.
**Fase:** Identity & Context Foundation con WIP operacional `0/1`; no existe
PBI actual y PBI-033 es el siguiente candidato, seleccionado y no iniciado.
...
`66aebdbb45f368755107db315772654bee5399a3`, run `34072709330`; véase
